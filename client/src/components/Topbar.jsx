  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-surface/80 backdrop-blur-md border-b border-outline-variant shadow-sm flex justify-between items-center h-16 px-margin-page max-w-container-max mx-auto">
      ...
      <div className="flex items-center gap-4">
        <button className="bg-primary-container text-on-primary py-1.5 px-4 rounded-lg text-sm font-medium hover:bg-surface-tint transition-colors">
          Add Vehicle
        </button>
        <button className="bg-surface border border-outline-variant text-on-surface py-1.5 px-4 rounded-lg text-sm font-medium hover:bg-surface-container transition-colors">
          Settings
        </button>
        <div className="flex items-center gap-2 border-l border-outline-variant pl-4 ml-2">
          ...
          <img 
            ...
            alt="User Avatar" 
            className="w-8 h-8 rounded-full ml-2 object-cover border border-outline-variant" 
          />
        </div>
      </div>
    </header>
